 ...
 */
public class SoundRainActivity extends ActionBarActivity {
    ...
    private MediaPlayer rain; // 치료 음악 지정
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sound_rain_activity);
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        mContext = getApplicationContext();
        inflater = (LayoutInflater) mContext.getSystemService(LAYOUT_INFLATER_SERVICE);
        setLayout();

        rain = MediaPlayer.create(this,R.raw.rainsound);
    ...
    public void setLayout() {
        ...
        mHeaderPicture = (KenBurnsSupportView) findViewById(R.id.rain_header_picture);
        mHeaderPicture.setResourceIds(R.drawable.sound_rain_bg1, R.drawable.sound_rain_bg2);
        mViewPager = (ViewPager) findViewById(R.id.rain_pager);
        ...
        dialog = new AlertDialog.Builder(this).setTitle("종료확인")
                ...
                .setPositiveButton("예", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        //dialog.dismiss();
                        Intent intent = new Intent(SoundRainActivity.this,SoundMainActivity.class);
