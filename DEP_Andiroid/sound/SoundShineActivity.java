 ...
 */
public class SoundShineActivity extends ActionBarActivity {
    ...
    private MediaPlayer shine;// 치료 음악 지정
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sound_shine_activity);
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        mContext = getApplicationContext();
        inflater = (LayoutInflater) mContext.getSystemService(LAYOUT_INFLATER_SERVICE);
        setLayout();

        shine = MediaPlayer.create(this,R.raw.shinesound);
        shine.setLooping(true);
        shine.start();
    }
    ...
    public void setLayout() {
        ...
        mHeaderPicture = (KenBurnsSupportView) findViewById(R.id.shine_header_picture);
        mHeaderPicture.setResourceIds(R.drawable.sound_shine_bg1, R.drawable.sound_shine_bg2);
        mViewPager = (ViewPager) findViewById(R.id.shine_pager);
        ...
        dialog = new AlertDialog.Builder(this).setTitle("종료확인")
                ...
                .setPositiveButton("예", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        //dialog.dismiss();
                        Intent intent = new Intent(SoundShineActivity.this,SoundMainActivity.class);
